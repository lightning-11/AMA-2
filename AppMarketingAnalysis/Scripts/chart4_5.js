...
{
	avgmaximumInstalls_free.push(parseFloat(summaximumInstalls_free[i])/parseFloat(count1_free[i]));
	avgratingcount_free.push(parseFloat(sumratingcount_free[i])/parseFloat(count2_free[i]));
}
